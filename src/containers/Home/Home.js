    ...
    return (
      <div id="pageHome">
        ...
        <div className="wrapper">
          ...
          <ul className="plates">
            {
              ...
              ? items.map((item, index) => (
                <li key={index} onClick={() => this.toggleDone(index)}>
          ...
          <form className="add-items" onSubmit={this.handleSubmit}>
            <input type="text" onChange={this.handleChange} value={addItem} placeholder="Item Name" required />
            <input type="submit" value="+ Add Item" />
          </form>
          <input type="button" value="Remove items from Localstorage" onClick={this.handleRemove}/>
        </div>
      </div>
    );
  }
