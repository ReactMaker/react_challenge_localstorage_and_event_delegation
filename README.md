...
![Imgur](https://i.imgur.com/KnpEEr0.gif)

## [DEMO](https://reactmaker.github.io/react_challenge_localstorage_and_event_delegation/#/)
...
```bash
$ git clone https://github.com/ReactMaker/react_challenge_localstorage_and_event_delegation
$ cd react_challenge_localstorage_and_event_delegation
